...
---------------------
module_name: Memory_Access_Point
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Cognitive_State_Protocol/Memory/Memory_Access_Point.py
...
class CompleteMemorySystem:
    ...
    def run_maintenance_cycle(self) -> Dict:
        ...
        report['forgetting'] = {
            ...
            'scheduled_ids': [m.get('memory_id') for m in due_for_review],
        }

        # 3. Reorganization (placeholder)
