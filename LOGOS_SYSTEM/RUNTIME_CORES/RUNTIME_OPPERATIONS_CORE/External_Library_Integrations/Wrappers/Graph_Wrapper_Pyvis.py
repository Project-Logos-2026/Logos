...
---------------------
module_name: Graph_Wrapper_Pyvis
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Protocol/External_Enhancements/Graph_Wrapper_Pyvis.py
...
__WRAPPER_ID__ = "Graph_pyvis"
__WRAPS__ = "pyvis"
__IMPORT_NAME__ = "pyvis"
__ROLE__ = "Graph"
__VERSION__ = "v1_stub"
...
class Graph_Wrapper_Pyvis:
    """
    Governed wrapper around external library 'pyvis'.
    ...
    def __init__(self) -> None:
        ...
        try:
            self._mod = lib_loader.get("pyvis")
        except Exception:
            # fallback: attempt require() (still governed by loader policy)
            self._mod = lib_loader.require("pyvis")
