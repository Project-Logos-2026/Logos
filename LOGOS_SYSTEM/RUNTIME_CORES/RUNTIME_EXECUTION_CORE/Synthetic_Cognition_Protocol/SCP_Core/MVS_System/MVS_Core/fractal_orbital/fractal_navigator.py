...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Synthetic_Cognition_Protocol/MVS_System/fractal_orbital/fractal_navigator.py
...
from logos.imports.agents import OntologicalType, FunctionType
