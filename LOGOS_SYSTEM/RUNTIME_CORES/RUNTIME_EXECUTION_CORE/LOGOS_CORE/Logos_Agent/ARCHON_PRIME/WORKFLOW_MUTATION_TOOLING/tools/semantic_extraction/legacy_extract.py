...
# module_id:            M-076
# module_name:          legacy_extract
# subsystem:            mutation_tooling
# module_role:          analysis
# canonical_path:       WORKFLOW_MUTATION_TOOLING/tools/semantic_extraction/legacy_extract.py
# responsibility:       Analysis module: legacy extract
