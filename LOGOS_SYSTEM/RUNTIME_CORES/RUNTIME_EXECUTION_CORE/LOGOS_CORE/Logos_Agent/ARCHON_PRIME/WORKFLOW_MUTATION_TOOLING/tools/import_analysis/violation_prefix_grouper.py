...
# module_id:            M-059
# module_name:          violation_prefix_grouper
# subsystem:            mutation_tooling
# module_role:          analysis
# canonical_path:       WORKFLOW_MUTATION_TOOLING/tools/import_analysis/violation_prefix_grouper.py
# responsibility:       Analysis module: violation prefix grouper
