...
# module_id:            M-052
# module_name:          generate_symbol_import_index
# subsystem:            mutation_tooling
# module_role:          analysis
# canonical_path:       WORKFLOW_MUTATION_TOOLING/tools/import_analysis/generate_symbol_import_index.py
# responsibility:       Analysis module: generate symbol import index
