...
# module_id:            M-084
# module_name:          cluster_analysis
# subsystem:            audit_tooling
# module_role:          analysis
# canonical_path:       WORKFLOW_TARGET_AUDITS/MODULES/analysis/dependency_graphs/cluster_analysis.py
# responsibility:       Analysis module: cluster analysis
...
def repair_feasibility(
    ...
    Output is written to OUTPUT_ROOT (see module-level OUTPUT_ROOT variable).
    """
