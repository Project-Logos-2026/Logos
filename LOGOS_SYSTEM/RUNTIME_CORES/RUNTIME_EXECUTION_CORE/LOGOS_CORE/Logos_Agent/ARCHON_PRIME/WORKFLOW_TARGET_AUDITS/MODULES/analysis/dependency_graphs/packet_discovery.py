...
# module_id:            M-085
# module_name:          packet_discovery
# subsystem:            audit_tooling
# module_role:          analysis
# canonical_path:       WORKFLOW_TARGET_AUDITS/MODULES/analysis/dependency_graphs/packet_discovery.py
# responsibility:       Analysis module: packet discovery
