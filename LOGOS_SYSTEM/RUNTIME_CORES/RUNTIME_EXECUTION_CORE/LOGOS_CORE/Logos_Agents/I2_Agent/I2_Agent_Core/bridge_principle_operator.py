...
---------------------
module_name: bridge_principle_operator
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Agents/I2_Agent/_core/bridge_principle_operator.py
...
# Configure logging only when invoked as a script
