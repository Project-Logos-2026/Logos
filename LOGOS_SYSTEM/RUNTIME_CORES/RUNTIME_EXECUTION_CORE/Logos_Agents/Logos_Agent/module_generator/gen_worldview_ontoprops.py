...
---------------------
module_name: gen_worldview_ontoprops
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Agents/Logos_Agent/module_generator/gen_worldview_ontoprops.py
...
def main(argv=None):
    ...
    if len(argv) < 2:
        print("[WARN] gen_worldview_ontoprops expects: <src> <out>")
        return
