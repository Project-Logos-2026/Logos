...
---------------------
module_name: fractal_consciousness_core
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Synthetic_Cognition_Protocol/consciousness/fractal_consciousness_core.py
...
# Configure logging for fractal consciousness monitoring when invoked as a script
...
class TrinityVector(BaseTrinityVector):
    ...
    def from_complex(cls, c: complex) -> "TrinityVector":
        ...
        e = min(1.0, abs(c.real))
        g = min(1.0, c.imag if isinstance(c.imag, float) else 1.0)
        t = min(1.0, abs(c.imag))
        return cls(e, g, t)
