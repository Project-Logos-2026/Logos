...
---------------------
module_name: test_Phase_E_Phase_E_Capability_Router
runtime_layer: inferred
role: Test module
responsibility: Defines runtime tests for LOGOS_SYSTEM/TEST_SUITE/Tests/test_Phase_E_Phase_E_Capability_Router.py.
agent_binding: None
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: LOGOS_SYSTEM/TEST_SUITE/Tests/test_Phase_E_Phase_E_Capability_Router.py
