...
# module_id:            M-038
# module_name:          nexus_structural_audit
# subsystem:            mutation_tooling
# module_role:          inspection
# canonical_path:       WORKFLOW_MUTATION_TOOLING/tools/audit_tools/nexus_structural_audit.py
# responsibility:       Inspection module: nexus structural audit
# runtime_stage:        audit
