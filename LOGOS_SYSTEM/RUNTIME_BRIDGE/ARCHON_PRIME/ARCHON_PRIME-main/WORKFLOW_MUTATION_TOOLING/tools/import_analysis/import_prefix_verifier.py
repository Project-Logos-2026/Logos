...
# module_id:            M-053
# module_name:          import_prefix_verifier
# subsystem:            mutation_tooling
# module_role:          analysis
# canonical_path:       WORKFLOW_MUTATION_TOOLING/tools/import_analysis/import_prefix_verifier.py
# responsibility:       Analysis module: import prefix verifier
