...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/System_Operations_Protocol/alignment_protocols/safety/ultima_framework/ultima_safety.py
...
class SafeguardStateMachine:
    ...
    def start_monitoring(self):
        ...
        logger.info("Ultima safety monitoring started")
    ...
    def stop_monitoring(self):
        ...
        logger.info("Ultima safety monitoring stopped")
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    logos_root = current_path.parents[3]
                    potential_paths = [
                        str(current_path.parent.parent),
                        str(current_path.parent.parent / "logos_core"),
                        str(logos_root),
                        str(logos_root / "logos_core"),
                        str(logos_root / "LOGOS_AGI"),
                        str(current_path),
                    ]
                    ...
                    import_attempts = [
                        ...
                        "System_Operations_Protocol.deployment.configuration.iel_runtime_interface",
                        "runtime.iel_runtime_interface",
                        "iel_runtime_interface",
                        "LOGOS_AGI.logos_core.runtime.iel_runtime_interface",
                    ]
    ...
    def ultima_trigger(self, reason: str = "Manual trigger") -> bool:
        """Manual ultima trigger - emergency system halt"""
        if self.system_halted or self.permanent_lockout:
            logger.warning(f"Ultima trigger ignored - system already halted: {reason}")
            return False
        ...
        violation = ViolationContext(
            ...
            timestamp=datetime.now(),
            triggering_operation="manual_ultima_trigger",
