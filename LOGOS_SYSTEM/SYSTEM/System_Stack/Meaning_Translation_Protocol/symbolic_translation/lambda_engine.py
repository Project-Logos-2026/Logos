...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Meaning_Translation_Protocol/symbolic_translation/lambda_engine.py
...
from .lambda_onto_calculus_engine import OntologicalType, FunctionType
