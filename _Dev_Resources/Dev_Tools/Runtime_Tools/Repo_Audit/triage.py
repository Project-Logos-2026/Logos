...
SOURCE_DIR  = Path("/workspaces/Logos/_Dev_Resources/STAGING/APPLICATION_FUNCTIONS")
DEST_REASON = Path("/workspaces/Logos/Blueprints/reasoning")
DEST_UTILS  = Path("/workspaces/Logos/Blueprints/utils")
...
def run():
    ...
    for entry in reasoning_move:
        ...
        reasoning_moved.append({
            ...
            "destination_path": str(dest_path.relative_to(Path("/workspaces/Logos"))),
