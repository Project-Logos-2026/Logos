...
AXIOMATIC GROUNDING
------------------
Assumes existing PXL axioms. No new axioms introduced.
"""

"""
CONTEXTUAL EMBEDDINGS
---------------------
Uses existing IEL domains only. No implicit lenses permitted.
"""

"""
APPLICATION FUNCTION INTERFACES
--------------------------------
All reasoning delegated to governed application functions.
(Interfaces only; implementations not authorized.)
"""
