...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Synthetic_Cognition_Protocol/MVS_System/predictors/fractal_mapping.py
    ...
    def compute_position(self, trinity_vector: tuple) -> dict:
        ...
        for i in range(self.max_iterations):
            ...
            if abs(z) > self.escape_radius:
                break
        tv = (
            t * (1 - abs(z) / self.escape_radius) if abs(z) <= self.escape_radius else 0
        )
