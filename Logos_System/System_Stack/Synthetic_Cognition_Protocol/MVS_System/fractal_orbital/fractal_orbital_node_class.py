...
---------------------
module_name: fractal_orbital_node_class
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Synthetic_Cognition_Protocol/MVS_System/fractal_orbital/fractal_orbital_node_class.py
...
try:
    from lambda_logos_core import LambdaLogosEngine, LogosExpr
except ImportError:
...
class OntologicalNode:
    def __init__(self, c_value: complex):
        ...
        self.category = (
            CategoryType.MATERIAL if c_value.imag == 0 else CategoryType.METAPHYSICAL
        )
        self.domain = (
            DomainType.LOGICAL
