...
---------------------
module_name: Cognition_Wrapper_Memgpt
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Protocol/External_Enhancements/Cognition_Wrapper_Memgpt.py
...
__WRAPPER_ID__ = "Cognition_memgpt"
__WRAPS__ = "memgpt"
__IMPORT_NAME__ = "memgpt"
__ROLE__ = "Cognition"
__VERSION__ = "v1_stub"
...
class Cognition_Wrapper_Memgpt:
    """
    Governed wrapper around external library 'memgpt'.
    ...
    def __init__(self) -> None:
        ...
        try:
            self._mod = lib_loader.get("memgpt")
        except Exception:
            # fallback: attempt require() (still governed by loader policy)
            self._mod = lib_loader.require("memgpt")
