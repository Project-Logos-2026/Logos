...
---------------------
module_name: Graph_Wrapper_Networkx
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Protocol/External_Enhancements/Graph_Wrapper_Networkx.py
...
__WRAPPER_ID__ = "Graph_networkx"
__WRAPS__ = "networkx"
__IMPORT_NAME__ = "networkx"
__ROLE__ = "Graph"
__VERSION__ = "v1_stub"
...
class Graph_Wrapper_Networkx:
    """
    Governed wrapper around external library 'networkx'.
    ...
    def __init__(self) -> None:
        ...
        try:
            self._mod = lib_loader.get("networkx")
        except Exception:
            # fallback: attempt require() (still governed by loader policy)
            self._mod = lib_loader.require("networkx")
