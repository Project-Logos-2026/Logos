...
---------------------
module_name: Cognition_Wrapper_Pgmpy
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Protocol/External_Enhancements/Cognition_Wrapper_Pgmpy.py
...
__WRAPPER_ID__ = "Cognition_pgmpy"
__WRAPS__ = "pgmpy"
__IMPORT_NAME__ = "pgmpy"
__ROLE__ = "Cognition"
__VERSION__ = "v1_stub"
...
class Cognition_Wrapper_Pgmpy:
    """
    Governed wrapper around external library 'pgmpy'.
    ...
    def __init__(self) -> None:
        ...
        try:
            self._mod = lib_loader.get("pgmpy")
        except Exception:
            # fallback: attempt require() (still governed by loader policy)
            self._mod = lib_loader.require("pgmpy")
