...
---------------------
module_name: ML_Wrapper_Prophet
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Protocol/External_Enhancements/ML_Wrapper_Prophet.py
...
__WRAPPER_ID__ = "ML_prophet"
__WRAPS__ = "prophet"
__IMPORT_NAME__ = "prophet"
__ROLE__ = "ML"
__VERSION__ = "v1_stub"
...
class ML_Wrapper_Prophet:
    """
    Governed wrapper around external library 'prophet'.
    ...
    def __init__(self) -> None:
        ...
        try:
            self._mod = lib_loader.get("prophet")
        except Exception:
            # fallback: attempt require() (still governed by loader policy)
            self._mod = lib_loader.require("prophet")
