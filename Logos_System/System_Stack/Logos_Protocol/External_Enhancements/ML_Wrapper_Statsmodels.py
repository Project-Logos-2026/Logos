...
---------------------
module_name: ML_Wrapper_Statsmodels
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Protocol/External_Enhancements/ML_Wrapper_Statsmodels.py
...
__WRAPPER_ID__ = "ML_statsmodels"
__WRAPS__ = "statsmodels"
__IMPORT_NAME__ = "statsmodels"
__ROLE__ = "ML"
__VERSION__ = "v1_stub"
...
class ML_Wrapper_Statsmodels:
    """
    Governed wrapper around external library 'statsmodels'.
    ...
    def __init__(self) -> None:
        ...
        try:
            self._mod = lib_loader.get("statsmodels")
        except Exception:
            # fallback: attempt require() (still governed by loader policy)
            self._mod = lib_loader.require("statsmodels")
