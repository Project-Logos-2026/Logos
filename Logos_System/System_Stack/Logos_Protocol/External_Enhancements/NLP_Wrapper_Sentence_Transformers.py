...
---------------------
module_name: NLP_Wrapper_Sentence_Transformers
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Protocol/External_Enhancements/NLP_Wrapper_Sentence_Transformers.py
...
__WRAPPER_ID__ = "NLP_sentence_transformers"
__WRAPS__ = "sentence-transformers"
__IMPORT_NAME__ = "sentence_transformers"
__ROLE__ = "NLP"
__VERSION__ = "v1_stub"
...
class NLP_Wrapper_Sentence_Transformers:
    """
    Governed wrapper around external library 'sentence-transformers'.
    ...
    def __init__(self) -> None:
        ...
        try:
            self._mod = lib_loader.get("sentence_transformers")
        except Exception:
            # fallback: attempt require() (still governed by loader policy)
            self._mod = lib_loader.require("sentence_transformers")
