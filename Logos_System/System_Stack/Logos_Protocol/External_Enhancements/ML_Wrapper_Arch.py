...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Protocol/External_Enhancements/ML_Wrapper_Arch.py
...
__WRAPPER_ID__ = "ML_arch"
__WRAPS__ = "arch"
__IMPORT_NAME__ = "arch"
__ROLE__ = "ML"
__VERSION__ = "v1_stub"
...
class ML_Wrapper_Arch:
    """
    Governed wrapper around external library 'arch'.
    ...
    def __init__(self) -> None:
        ...
        try:
            self._mod = lib_loader.get("arch")
        except Exception:
            # fallback: attempt require() (still governed by loader policy)
            self._mod = lib_loader.require("arch")
