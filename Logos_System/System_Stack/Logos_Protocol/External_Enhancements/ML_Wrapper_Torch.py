...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Protocol/External_Enhancements/ML_Wrapper_Torch.py
...
__WRAPPER_ID__ = "ML_torch"
__WRAPS__ = "torch"
__IMPORT_NAME__ = "torch"
__ROLE__ = "ML"
__VERSION__ = "v1_stub"
...
class ML_Wrapper_Torch:
    """
    Governed wrapper around external library 'torch'.
    ...
    def __init__(self) -> None:
        ...
        try:
            self._mod = lib_loader.get("torch")
        except Exception:
            # fallback: attempt require() (still governed by loader policy)
            self._mod = lib_loader.require("torch")
