...
---------------------
module_name: Cognition_Wrapper_Sympy
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Protocol/External_Enhancements/Cognition_Wrapper_Sympy.py
...
__WRAPPER_ID__ = "Cognition_sympy"
__WRAPS__ = "sympy"
__IMPORT_NAME__ = "sympy"
__ROLE__ = "Cognition"
__VERSION__ = "v1_stub"
...
class Cognition_Wrapper_Sympy:
    """
    Governed wrapper around external library 'sympy'.
    ...
    def __init__(self) -> None:
        ...
        try:
            self._mod = lib_loader.get("sympy")
        except Exception:
            # fallback: attempt require() (still governed by loader policy)
            self._mod = lib_loader.require("sympy")
