...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Protocol/External_Enhancements/NLP_Wrapper_Spacy.py
...
__WRAPPER_ID__ = "NLP_spacy"
__WRAPS__ = "spacy"
__IMPORT_NAME__ = "spacy"
__ROLE__ = "NLP"
__VERSION__ = "v1_stub"
...
class NLP_Wrapper_Spacy:
    """
    Governed wrapper around external library 'spacy'.
    ...
    def __init__(self) -> None:
        ...
        try:
            self._mod = lib_loader.get("spacy")
        except Exception:
            # fallback: attempt require() (still governed by loader policy)
            self._mod = lib_loader.require("spacy")
