...
---------------------
module_name: Cognition_Wrapper_Openai
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Protocol/External_Enhancements/Cognition_Wrapper_Openai.py
...
__WRAPPER_ID__ = "Cognition_openai"
__WRAPS__ = "openai"
__IMPORT_NAME__ = "openai"
__ROLE__ = "Cognition"
__VERSION__ = "v1_stub"
...
class Cognition_Wrapper_Openai:
    """
    Governed wrapper around external library 'openai'.
    ...
    def __init__(self) -> None:
        ...
        try:
            self._mod = lib_loader.get("openai")
        except Exception:
            # fallback: attempt require() (still governed by loader policy)
            self._mod = lib_loader.require("openai")
