...
---------------------
module_name: Cognition_Wrapper_Micropsi
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Protocol/External_Enhancements/Cognition_Wrapper_Micropsi.py
...
__WRAPPER_ID__ = "Cognition_micropsi"
__WRAPS__ = "micropsi"
__IMPORT_NAME__ = "micropsi"
__ROLE__ = "Cognition"
__VERSION__ = "v1_stub"
...
class Cognition_Wrapper_Micropsi:
    """
    Governed wrapper around external library 'micropsi'.
    ...
    def __init__(self) -> None:
        ...
        try:
            self._mod = lib_loader.get("micropsi")
        except Exception:
            # fallback: attempt require() (still governed by loader policy)
            self._mod = lib_loader.require("micropsi")
