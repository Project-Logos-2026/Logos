...
---------------------
module_name: ML_Wrapper_Sklearn
...
failure_mode:
  ...
  notes: ""
rewrite_provenance:
  source: System_Stack/Logos_Protocol/External_Enhancements/ML_Wrapper_Sklearn.py
...
__WRAPPER_ID__ = "ML_sklearn"
__WRAPS__ = "scikit-learn"
__IMPORT_NAME__ = "sklearn"
__ROLE__ = "ML"
__VERSION__ = "v1_stub"
...
class ML_Wrapper_Sklearn:
    """
    Governed wrapper around external library 'scikit-learn'.
    ...
    def __init__(self) -> None:
        ...
        try:
            self._mod = lib_loader.get("sklearn")
        except Exception:
            # fallback: attempt require() (still governed by loader policy)
            self._mod = lib_loader.require("sklearn")
