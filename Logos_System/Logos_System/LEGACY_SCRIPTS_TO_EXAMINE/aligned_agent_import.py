...
# path: /workspaces/Logos_System/_Dev_Resources/Dev_Scripts/LEGACY_SCRIPTS_TO_EXAMINE/INSPECT_DECIDE/_Dev_Resources/LEGACY_SCRIPTS_TO_EXAMINE/INSPECT_DECIDE/aligned_agent_import.py
# role: dev_tool
...
def main(
    ...
    if pin_sha:
        print(f">> Pin override requested — checking out {pin_sha}")
        ...
        print(">> No pin found — syncing to origin/main")
        try:
            ensure_repo(REPO_URL, DEST_DIR)
        except subprocess.CalledProcessError as exc:  # pragma: no cover
            print(
