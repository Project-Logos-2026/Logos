...
# path: /workspaces/Logos_System/_Dev_Resources/Dev_Scripts/LEGACY_SCRIPTS_TO_EXAMINE/INSPECT_DECIDE/_Dev_Resources/LEGACY_SCRIPTS_TO_EXAMINE/could_be_dev/capture_arp_traces_and_backfill.py
# role: dev_tool
...
SCENARIOS: Dict[str, Dict[str, str]] = {
    "SCP_MODAL_CAUSAL_BASELINE": {
        ...
        "prompt_focus": ("Causal safeguards gating any future nexus activation."),
    },
    "SCP_MODAL_EPISTEMIC_KNOWLEDGE": {
        ...
        "prompt_focus": ("Epistemic limits that preserve constructive guarantees."),
    },
}
